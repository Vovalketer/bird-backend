...
public class ErrorMessages {
	public static final String INVALID_TOKEN = "The provided token is expired or invalid";
	public static final String EXPIRED_TOKEN = "The provided token is expired";
